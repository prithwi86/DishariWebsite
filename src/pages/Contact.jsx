...
function Contact() {
  ...
  const bgUrl = contact?.background_img_url || contactBg
  ...
  const showError = (contactEmail) => {
    setModal({
      type: 'error',
      message: `This service is currently offline. But you can email us directly at ${contactEmail}. We are very sorry for the inconvenience.`,
      email: contactEmail,
    })
  }
  ...
  const showSuccess = () => {
    ...
    setTimeout(() => {
      setFlyAway(false)
      setModal({ type: 'success', message: 'Message sent successfully' })
  ...
  const handleSubmit = async (e) => {
    ...
    const contactEmail = contact?.email || 'support@dishariboston.org'
    ...
    try {
      ...
      if (import.meta.env.DEV && SMTP2GO_API_KEY && SMTP2GO_SENDER) {
        // Local development: call SMTP2GO directly (key is only in .env.development)
        res = await fetch('https://api.smtp2go.com/v3/email/send', {
          ...
          body: JSON.stringify({
            ...
            text_body: `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`,
            html_body: `<h3>New message from Dishari Website</h3><p><strong>Name:</strong> ${name}</p><p><strong>Email:</strong> <a href="mailto:${email}">${email}</a></p><hr/><p>${message.replace(/\n/g, '<br/>')}</p>`,
          }),
        })
        ...
        // Production: call PHP proxy (API key is server-side)
  ...
  return (
    <>
      {/* Contact section with image banner */}
      <section className="contact-page-header">
        <div className="container">
          <div className="contact-header-banner">
            <img src={bgUrl} alt="Contact Dishari Boston" className="contact-header-img" />
            <div className="contact-header-overlay">
              <h1>Contact Us</h1>
              <p>
                Get in Touch with Dishari Boston. We&rsquo;d love to hear from you!
                Whether you have questions, want to volunteer, or are interested in
                supporting our mission, please reach out.
              </p>
              ...
              <div className="contact-header-info">
                ...
                <div className="contact-header-row">
                  ...
                  <a href={`mailto:${contact?.email || 'support@dishariboston.org'}`}>
                    {contact?.email || 'support@dishariboston.org'}
                  </a>
                </div>
                {contact?.phone && (
                  <div className="contact-header-row">
          ...
          {/* --- background-image approach (commented out) ---
          <div className="contact-header-body">
            <p>
              Get in Touch with Dishari Boston. We'd love to hear from you!
              Whether you have questions, want to volunteer, or are interested in
              supporting our mission, please reach out.
            </p>
            <div className="contact-header-info">
      ...
      <section className="contact-section">
        <div className="contact-talk-container">
          ...
          {/* SVG Illustration */}
          <svg className={`contact-talk-svg${flyAway ? ' fly-away' : ''}`} ref={svgRef} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none">
            <g id="Image">
              <g id="g14">
                <g id="g16">
                  <g id="g22">
          ...
          {/* Contact Form */}
          <form className="contact-talk-form" onSubmit={handleSubmit}>
            <h1 className="contact-talk-title">Talk to Us</h1>

            <div className="contact-talk-field">
              <label htmlFor="name">
                <i className="fas fa-user contact-talk-icon"></i>
              </label>
              <input
                type="text"
                id="name"
                name="name"
                className="contact-talk-input"
                placeholder="Name"
                value={formData.name}
            ...
            <div className="contact-talk-field">
              <label htmlFor="email">
                <i className="fas fa-envelope contact-talk-icon"></i>
              </label>
              <input
                type="email"
                id="email"
            ...
            <div className="contact-talk-field contact-talk-message">
              <textarea
                id="message"
                name="message"
                className="contact-talk-input"
            ...
            <div className="contact-talk-submit">
              <button type="submit" className="contact-talk-btn" disabled={sending}>
          ...
          {/* Floating modal */}
          {modal && (
            <div className={`contact-modal-overlay${modal.type === 'success' ? ' success' : ' error'}`}>
              <div className="contact-modal">
                <i className={`fas ${modal.type === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle'}`}></i>
                <p>
                  {modal.type === 'error' && modal.email ? (
                    <>
                      This service is currently offline. But you can email us directly at{' '}
                      <a href={`mailto:${modal.email}`}>{modal.email}</a>.
                ...
                <button className="contact-modal-close" onClick={() => setModal(null)}>
